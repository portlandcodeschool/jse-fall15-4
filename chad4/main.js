...
deckOfCards.sort(function(a,b){return a.suit() - b.suit()});
deckOfCards.cut();
...
var deckOfNames = makeDeque(['Chad','Wendy','Sara','Emi','Greg','Anastasia','Elizabeth','Natalie','Stephen','David','Harrison','Molly','Matt','Tim','Louise','Elijah']);
deckOfNames.array.sort(function(a,b){
  var x = a.toLowerCase(), y = b.toLowerCase();
  if (x.charAt(1) < y.charAt(1)) //sort string ascending
    return -1 
